...
python ./train_bn_mcmc.py 53 0 1 0 SLP sigmoid data/Beijing/sets/Train_24_hour_norm.csv data/Beijing/sets/Test_24_hour_norm.csv results/Beijing_SLP_Sigmoid/ MASE 1000

python ./train_bn_mcmc.py 53 0 1 0 SLP sigmoid data/Beijing/sets/Train_24_hour_diff.csv data/Beijing/sets/Test_24_hour_diff.csv  results/Beijing_SLP_Sigmoid_Diff/ MASE 1000 

python ./train_bn_mcmc.py 53 0 1 0 SLP sigmoid data/Beijing/sets/Train_24_hour_prop_diff.csv data/Beijing/sets/Test_24_hour_prop_diff.csv results/Beijing_SLP_Sigmoid_Prop_Diff/ MASE 1000
