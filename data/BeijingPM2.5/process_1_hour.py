...
unwanted = ["No", "year", "month", "day", "TARGET_pm2.5_1_DIFF"] 
...
nzr.write_field_config(config, target_col, 'Target_1_nzr_config.yaml')

train_df_norm = nzr.normalize(train_df2, config, ['N','S','E','W'])
test_df_norm = nzr.normalize(test_df2, config, ['N','S','E','W'])

train_df_norm.to_csv('Train_set_1_hour_normalised.csv', sep=' ', encoding='utf-8', index=False, header=False)
test_df_norm.to_csv('Test_set_1_hour_normalised.csv', sep=' ', encoding='utf-8', index=False, header=False)
