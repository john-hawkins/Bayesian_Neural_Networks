...
python analyse_test_results.py "./results/Beijing_SLP_Sigmoid" "./results/Beijing_SLP_Sigmoid/test_predictions_final.tsv" "./data/Beijing/sets/Test_24_hour_full.csv" 100 "TARGET_pm2.5_24_VALUE" "pm2.5"
...
python analyse_test_results.py "./results/Beijing_SLP_Sigmoid_Diff" "./results/Beijing_SLP_Sigmoid_Diff/test_predictions_final.tsv" "./data/Beijing/sets/Test_24_hour_full.csv" 100 "TARGET_pm2.5_24_DIFF" "pm2.5"
...
python analyse_test_results.py "./results/Beijing_SLP_Sigmoid_Prop_Diff" "./results/Beijing_SLP_Sigmoid_Prop_Diff/test_predictions_final.tsv" "./data/Beijing/sets/Test_24_hour_full.csv" 100 "TARGET_pm2.5_24_PROP_DIFF" "pm2.5"
